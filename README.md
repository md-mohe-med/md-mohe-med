...
<table style="width:100%;border-collapse:collapse;margin-bottom:20px;font-size:14px;">
  <thead>
    <tr style="background:#f6f8fa;">
      <th style="border:1px solid #d0d7de;padding:8px 12px;text-align:left;font-weight:600;color:#57606a;">Technology</th>
      <th style="border:1px solid #d0d7de;padding:8px 12px;text-align:left;font-weight:600;color:#57606a;">Icon</th>
      <th style="border:1px solid #d0d7de;padding:8px 12px;text-align:left;font-weight:600;color:#57606a;">Category</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<table style="width:100%;border-collapse:collapse;margin-bottom:20px;font-size:14px;">
  <thead>
    <tr style="background:#f6f8fa;">
      <th style="border:1px solid #d0d7de;padding:8px 12px;text-align:left;font-weight:600;color:#57606a;">Technology</th>
      <th style="border:1px solid #d0d7de;padding:8px 12px;text-align:left;font-weight:600;color:#57606a;">Icon</th>
      <th style="border:1px solid #d0d7de;padding:8px 12px;text-align:left;font-weight:600;color:#57606a;">Type</th>
    </tr>
  </thead>
  <tbody>
    <tr>
...
<h2 style="font-size:22px;font-weight:700;color:#24292f;margin:28px 0 14px;padding-bottom:8px;border-bottom:1px solid #d0d7de;">📊 GitHub Stats</h2>
<div style="display:flex;gap:16px;flex-wrap:wrap;margin-top:4px;">
  <div style="background:#f6f8fa;border:1px solid #d0d7de;border-radius:8px;padding:16px 20px;min-width:220px;flex:1;">
    <h3 style="font-size:14px;font-weight:700;color:#57606a;margin-bottom:12px;">Mohammed's GitHub Stats</h3>
    <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:7px;"><span style="color:#57606a;">⭐ Total Stars Earned:</span><span style="font-weight:700;color:#0550ae;">–</span></div>
    <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:7px;"><span style="color:#57606a;">🔄 Total Commits (2026):</span><span style="font-weight:700;color:#0550ae;">–</span></div>
    <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:7px;"><span style="color:#57606a;">🔃 Total PRs:</span><span style="font-weight:700;color:#0550ae;">–</span></div>
    <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:7px;"><span style="color:#57606a;">❗ Total Issues:</span><span style="font-weight:700;color:#0550ae;">–</span></div>
    <div style="display:flex;justify-content:space-between;font-size:13px;margin-bottom:7px;"><span style="color:#57606a;">📦 Contributed to (last year):</span><span style="font-weight:700;color:#0550ae;">–</span></div>
  </div>
  <div style="background:#f6f8fa;border:1px solid #d0d7de;border-radius:8px;padding:16px 20px;min-width:220px;flex:1;">
    <h3 style="font-size:14px;font-weight:700;color:#57606a;margin-bottom:12px;">Most Used Languages</h3>
    <div style="height:8px;border-radius:4px;overflow:hidden;display:flex;margin-bottom:12px;">
      <span style="display:block;height:100%;width:50%;background:#f1e05a;"></span>
      <span style="display:block;height:100%;width:15%;background:#4F5D95;"></span>
      <span style="display:block;height:100%;width:12%;background:#e34c26;"></span>
      <span style="display:block;height:100%;width:10%;background:#3572A5;"></span>
      <span style="display:block;height:100%;width:8%;background:#563d7c;"></span>
      <span style="display:block;height:100%;width:5%;background:#555555;"></span>
    </div>
    <div style="display:flex;flex-wrap:wrap;gap:10px 16px;font-size:12px;color:#57606a;">
      <span style="display:flex;align-items:center;gap:5px;"><span style="width:10px;height:10px;border-radius:50%;background:#f1e05a;display:inline-block;"></span>JavaScript</span>
      <span style="display:flex;align-items:center;gap:5px;"><span style="width:10px;height:10px;border-radius:50%;background:#4F5D95;display:inline-block;"></span>PHP</span>
      <span style="display:flex;align-items:center;gap:5px;"><span style="width:10px;height:10px;border-radius:50%;background:#e34c26;display:inline-block;"></span>HTML</span>
      <span style="display:flex;align-items:center;gap:5px;"><span style="width:10px;height:10px;border-radius:50%;background:#563d7c;display:inline-block;"></span>CSS</span>
    </div>
  </div>
</div>
